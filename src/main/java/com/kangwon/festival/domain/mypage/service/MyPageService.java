package com.kangwon.festival.domain.mypage.service;
...
import com.kangwon.festival.domain.mypage.repository.MypageGuestbookRepository;
import com.kangwon.festival.domain.mypage.repository.MypageUserBlockRepository;
...
public class MyPageService {
    ...
    public List<GuestbookResponse> getMyGuestbook(Long userId) {
        ...
        return guestbookRepository.findByUserAndGuestbookIsDeletedFalseOrderByCreatedDateTimeDesc(user)
                .stream()
